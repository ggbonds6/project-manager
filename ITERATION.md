...
| v1.8 | 2026-09-08 | 项目概览：README 式介绍 + 功能模块清单 | 新表 `project_overview`（V6：intro_md + modules_json）；详情接口带 overview；项目信息页新增"项目介绍(Markdown 渲染)/功能模块(两级)"展示与编辑；提供演示概览 mock SQL | `(待提交)` |
